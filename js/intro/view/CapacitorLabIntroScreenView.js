...
/**
 * View for CapacitorLab.
 *
 * TODO: Most of this is commented out for now.  Much of the model is still in progress and view elements will be added
 * to the screen as the model is completed.  In addition, much of the code written here can probably be moved to
 * CapacitorLabScreenView.
 *
 * @author Chris Malley
